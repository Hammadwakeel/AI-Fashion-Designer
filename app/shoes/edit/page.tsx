...
import { Loader2, Wand2, Footprints } from "lucide-react"
...
export default function EditShoePage() {
  ...
  return (
    <div className="container mx-auto py-10 px-4 min-h-screen">
      ...
      <PageNavigation
        links={[
          { name: "Shoes", href: "/shoes/create" },
          { name: "Edit", href: "/shoes/edit" },
        ]}
        title="Edit Shoe Design"
      />
      <motion.div
      ...
      >
        ...
        <p className="text-xl text-muted-foreground text-center max-w-2xl">
          Upload a shoe image and modify it with text instructions
        </p>
      </motion.div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <motion.div className="bg-gradient-black card-gradient" variants={slideUp} initial="hidden" animate="visible">
          <div className="flex flex-col space-y-1.5 p-6">
            ...
            <p className="text-sm text-muted-foreground">Upload a shoe image to edit</p>
          </div>
        ...
        <motion.div className="bg-gradient-black card-gradient" variants={slideUp} initial="hidden" animate="visible">
          <div className="flex flex-col space-y-1.5 p-6">
            ...
            <p className="text-sm text-muted-foreground">Describe how you want to modify the shoe</p>
          </div>
          <div className="p-6 pt-0 space-y-4">
            <div>
            ...
            {updatedImage && (
              <div className="mt-6">
                <h4 className="text-lg font-semibold mb-2">Updated Shoe</h4>
                <div className="relative w-full aspect-square bg-gray-800 rounded-md overflow-hidden">
                  <img
