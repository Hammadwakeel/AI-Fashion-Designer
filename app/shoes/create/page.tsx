...
export default function CreateShoePage() {
  ...
  return (
    <div className="container mx-auto py-10 px-4 min-h-screen">
      <PageNavigation links={[{ name: "Shoes", href: "/shoes/create" }]} title="Create Shoe Design" />
      ...
      >
        ...
        <p className="text-xl text-muted-foreground text-center max-w-2xl">
          Describe the shoe you want to create and our AI will bring it to life
        </p>
      </motion.div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="grid grid-cols-1 gap-8">
            ...
            >
              <div className="flex flex-col space-y-1.5 p-6 pt-0">
                <h3 className="text-2xl font-semibold leading-none tracking-tight">Describe Your Shoe</h3>
                <p className="text-sm text-muted-foreground">Enter a description of the shoe you want to create</p>
              </div>
            ...
            >
              <div className="flex flex-col space-y-1.5 p-6">
                ...
                <p className="text-sm text-muted-foreground">Your AI-generated shoe will appear here</p>
              </div>
        ...
        <div className="hidden lg:block">
          <CreationSidebar type="shoe" editLink="/shoes/edit" />
        </div>
      </div>
    </div>
  )
